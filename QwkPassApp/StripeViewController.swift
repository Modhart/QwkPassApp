...
class StripeViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let stripePublishableKey = "pk_test_D91WayCvhLBZNvpZbDSecmxt"
    ...
    init(product: String, price: Int, settings: Settings) {
        ...
        assert(stripePublishableKey.hasPrefix("pk_test_D91WayCvhLBZNvpZbDSecmxt"), "You must set your Stripe publishable key at the top of CheckoutViewController.swift to run this app.")
